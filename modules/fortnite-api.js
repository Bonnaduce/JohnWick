//Dependencies for Fotnite-API
const axios = require("axios");
const qs = require("qs");
//Here we load the endpoints and methods for stats
...
class FortniteApi {
  ...
  checkPlayer(username, platform, timeWindow) {
    return new Promise((resolve, reject) => {
      ...
      if (!(platform == "pc" || platform == "ps4" || platform == "xb1" || platform == "mobile")) {
    ...
    return new Promise((resolve, reject) => {
      ...
      switch (lang.toLowerCase()) {
        ...
        case "en": // English
          ...
          break;
        case "es": // English
          headers["X-EpicGames-Language"] = "es-MX";
          break;
        default: // Default English
          headers["X-EpicGames-Language"] = "en";
      }
